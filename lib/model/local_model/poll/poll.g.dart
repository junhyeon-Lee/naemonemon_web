...
_$_Poll _$$_PollFromJson(Map<String, dynamic> json) => _$_Poll(
      ...
      items: (json['items'] as List<dynamic>)
          ...
          .toList(),
      votedUserDeviceToken: json['votedUserDeviceToken'] as String,
      like: json['like'] as bool,
      likeLength: json['likeLength'] as int,
      comments: (json['comments'] as List<dynamic>)
          .map((e) => Comment.fromJson(e as Map<String, dynamic>))
          .toList(),
      isAlreadyVoted: json['isAlreadyVoted'] as bool,
...
Map<String, dynamic> _$$_PollToJson(_$_Poll instance) => <String, dynamic>{
      ...
      'votedUserDeviceToken': instance.votedUserDeviceToken,
      'like': instance.like,
      'likeLength': instance.likeLength,
      'comments': instance.comments,
      'isAlreadyVoted': instance.isAlreadyVoted,
      'join': instance.join,
      'user': instance.user,
    };
